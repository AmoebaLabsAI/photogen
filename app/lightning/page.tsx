...
const LightningPage: React.FC = () => {
  ...
  const handleDownload = (url: string) => {
    ...
    link.href = url;
    link.download = "lightning-image.webp";
  ...
  return (
    <div className="flex flex-col md:flex-row h-[100vh] overflow-hidden">
      ...
      <div className="w-full md:w-1/4 p-4 md:p-6 flex flex-col bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500">
        <form onSubmit={handleSubmit} className="flex flex-col">
          <div className="mb-4">
            <textarea
              ...
              className="w-full h-32 md:h-full p-2 border-2 border-white rounded-xl focus:ring-2 focus:ring-yellow-600 focus:border-transparent resize-none bg-white bg-opacity-20 text-white placeholder-white placeholder-opacity-70"
            />
          </div>
          <button
            type="submit"
          ...
          >
            {isLoading ? <>Conjuring Image...</> : "Generate Lightning"}
          </button>
        </form>
      </div>

      {/* Main content (bottom on mobile) */}
      <div className="w-full md:w-3/4 p-4 md:p-6 overflow-y-auto flex-grow bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 flex items-center justify-center">
