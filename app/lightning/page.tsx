...
const LightningPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
          <div className="mb-4">
            <textarea
              ...
              className="w-full h-32 md:h-40 p-2 border-2 border-white rounded-xl focus:ring-2 focus:ring-yellow-600 focus:border-transparent resize-none bg-white bg-opacity-20 text-white placeholder-white placeholder-opacity-70"
            />
          </div>
          <button
            type="submit"
      ...
      <div className="w-full md:w-3/4 p-4 md:p-6 flex-grow bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 flex items-center justify-center overflow-hidden">
